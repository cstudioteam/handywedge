...
public class FWConverterConst {
  ...
  public static final String EXTENSION_PPS = "pps"; // PowerPoint 2007 より前の Microsoft PowerPoint
                                                    // スライドショー
  ...
  public static final List<String> OFFICE_DOCUMENT_EXTENSIONS =
      Arrays.asList(EXTENSION_DOC, EXTENSION_DOCX, EXTENSION_DOT, EXTENSION_DOTX, EXTENSION_DOCM,
          EXTENSION_XLS, EXTENSION_XLSX, EXTENSION_XLT, EXTENSION_XLTX, EXTENSION_XLM,
          EXTENSION_XLTM, EXTENSION_XLSM, EXTENSION_XLA, EXTENSION_XLAM, EXTENSION_XLL,
          EXTENSION_PPT, EXTENSION_PPTX, EXTENSION_PPTM, EXTENSION_PPS, EXTENSION_PPSM,
          EXTENSION_PPAM, EXTENSION_PPSX, EXTENSION_POT, EXTENSION_POTX, EXTENSION_POTM);
