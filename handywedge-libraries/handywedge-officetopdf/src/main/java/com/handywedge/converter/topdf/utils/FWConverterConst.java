...
public class FWConverterConst {
  ...
  public static final List<String> OFFICE_DOCUMENT_EXTENSIONS = Arrays.asList(EXTENSION_DOC,
      EXTENSION_DOCX, EXTENSION_XLS, EXTENSION_XLSX, EXTENSION_PPT, EXTENSION_PPTX);
}
