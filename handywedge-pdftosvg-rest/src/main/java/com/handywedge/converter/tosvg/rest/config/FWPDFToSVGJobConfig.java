...
public class FWPDFToSVGJobConfig {
	...
	public int getPageThreshold() {
		logger.info( " [converter.page.threshold: {}]", appProperties.getProperty("converter.page.threshold") );
	...
	public int getMultithreadNumber() {
		logger.info( " [converter.multithread.number: {}]", appProperties.getProperty("converter.multithread.number") );
