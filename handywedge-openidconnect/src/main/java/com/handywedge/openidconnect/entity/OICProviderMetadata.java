...
/**
 * OpenId Provuiderのコンフィグレーションメタデータ。
 * 
 * @author takeuchi
 */
public class OICProviderMetadata {
    ...
    public void setRevocation_endpoint_auth_signing_alg_values_supported(String revocation_endpoint_auth_signing_alg_values_supported) {
    ...
    public void setIntrospection_endpoint_auth_methods_supported(String introspection_endpoint_auth_methods_supported) {
    ...
    public void setIntrospection_endpoint_auth_signing_alg_values_supported(String[] introspection_endpoint_auth_signing_alg_values_supported) {
