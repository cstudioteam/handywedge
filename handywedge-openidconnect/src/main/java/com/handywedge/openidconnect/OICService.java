...
public abstract class OICService {
    ...
    public void auth(HttpServletRequest request, HttpServletResponse response) throws OICException {
        ...
        try {
            ...
            if (error != null) {
                ...
                response.getOutputStream().print("{\n \"return_cd\": -9000,\n \"return_msg\": \"["
                        + error + "] " + request.getParameter(OICConst.TAG_NAME_ERROR_DESCRIPTION) + "\"\n}");
                return;
            }
        ...
        } catch(InvalidKeyException | SignatureException | CertificateException | InvalidKeySpecException | IOException | NoSuchAlgorithmException e) {
        ...
        switch(responseType) {
            case "id_token" :
                sb.append("?")
                    ...
                    .append(OICProperties.get(OICConst.RESPONSE_MODE))
                    .append("&")
                    .append("redirect_uri=")
                    .append(getRedirectURL(OICProperties.get(OICConst.RP_AUTH_PATH)))
                    .append("&")
                    .append("scope=")
                    .append(OICProperties.get(OICConst.SCOPE))
                    .append("&")
                    .append("state=")
                    .append(state.getId())
                    .append("&")
                    ...
                    .append("&")
                    .append("client_id=")
                    .append(OICProperties.get(OICConst.CLIENT_ID));
                    break;
            default:
    ...
    protected PublicKey getPublicKey(String kid) throws InvalidKeySpecException, CertificateException, OICException, NoSuchAlgorithmException {
        ...
        if (key.getX5c() == null || key.getX5c().length == 0) {
            ...
            X509Certificate cert = (X509Certificate) factory.generateCertificate(new ByteArrayInputStream(pk.getBytes()));
    ...
    protected String getBaseURL() {
        ...
        sb.append(OICProperties.get(OICConst.RP_SCHEMA))
            .append("://")
    ...
    protected String handywedgeLogin(OICUserInfo userInfo) throws OICException, IOException, InvalidKeyException, SignatureException, CertificateException, InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        try {
            ...
            String json = (String)invokePostAPI(OICProperties.get(OICConst.HW_SSO_LOGIN_ENDPOINT), null, map, String.class);
    ...
    private <T> T invokeGetAPI(String url,  String path, String query, Class clazz) throws OICException {
    ...
    private <T> T invokePostAPI(String url,  String path, Map<String, String> param, Class clazz) throws OICException {
