...
public class FWResultSetWrapper implements FWFullResultSet {
    ...
    @Override
    public FWStatement getStatement() throws SQLException {

        return new FWStatementWrapper(resultSet.getStatement());
    }
